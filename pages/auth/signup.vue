<template>
  <NuxtLayout name="auth">
    <!-- ====== Forms Section Start -->
    <div class="rounded-sm shadow-default">
      <div class="grid grid-cols-2 items-center w-full h-screen">
        <div class="w-full">
          <div class="py-17.5 px-26 text-center">
            <NuxtLink to="/" class="mb-5.5 inline-block">
              <nuxt-img class="w-60" src="/img/habitzkid.png" alt="Logo" />
            </NuxtLink>
        ...
        <div class="w-full py-5">
          <div class="w-full p-4 sm:px-12.5 xl:px-17.5">
            <span class="mb-1.5 block font-medium">Register New Account</span>
            ...
            <div class="mb-4">
              ...
              <span v-if="validate.name.$error" class="text-red-600">Nama wajib diisi</span>
            </div>
            ...
            <div class="mb-4">
              <label class="mb-2.5 block font-medium">Password</label>
              <div class="relative">
                <input
                  type="password"
                  v-model="password"
            ...
            <div class="mb-6">
              <label class="mb-2.5 block font-medium">Re-type Password</label>
              <div class="relative">
                <input
                  type="password"
              ...
              <span v-if="validate.passwordRepeat.$error" class="text-red-600">Password tidak sama</span>
            </div>
            ...
            <div class="mt-6 text-center">
              <p class="font-medium">
                ...
                <NuxtLink to="/auth/signin" class="text-primary"
                  >Sign in</NuxtLink
                >
              </p>
            </div>
...
// SupabaseClient Untuk queri ke database
const supabase = useSupabaseClient();

// SupabaseAuthClient untuk semua function yang berhubungan dengan auth 
const client = useSupabaseAuthClient();

// SupabaseUser untuk mengambil data session user yang sudah login
